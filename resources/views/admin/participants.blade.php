...
@section('content')
    ...
    <style>
        /* Ensure table is always visible while debugging */
        #participantsTable {
            width: 100% !important;
            margin: 0 !important;
        }
            ...
            <div class="flex flex-col md:flex-row items-end gap-3 pt-2 border-t border-surface-100">
                <div class="grid grid-cols-2 lg:flex gap-3 flex-1 w-full">
                    ...
                    <div class="relative flex-1 md:flex-none self-end">
                        ...
                        <div id="colDropdown"
                            ...
                            <div class="mt-3 pt-2 border-t flex justify-between">
                ...
                <div class="flex gap-2 w-full md:w-auto">
                    <button type="button" onclick="exportData()"
                        class="px-4 py-2 bg-surface-100 border border-surface-300 text-xs font-bold rounded-xl h-[38px] cursor-pointer">EXPORT
                        TO CSV</button>
                    <button type="submit"
    ...
    <div class="bg-white border border-surface-300 rounded-xl overflow-hidden shadow-sm">
        ...
        <div class="overflow-x-auto">
            <table id="participantsTable" class="w-full text-sm display compact">
                <thead>
                    <tr>
