...
<div class="bg-white border border-surface-300 rounded-xl">
    <div class="p-4 border-b border-surface-300">
        <form method="GET" class="flex flex-wrap gap-3">
            <input type="text" name="search" value="{{ request('search') }}" placeholder="{{ __('messages.admin_search_placeholder') }}" class="flex-1 min-w-[200px] px-4 py-2.5 bg-surface-50 border border-surface-300 rounded-xl text-sm text-surface-900 placeholder-surface-700 focus:border-brand-500 focus:ring-1 focus:ring-brand-500">
            <select name="category" class="px-4 py-2.5 bg-surface-50 border border-surface-300 rounded-xl text-sm text-surface-900 focus:border-brand-500">
            ...
            <select name="payment_status" class="px-4 py-2.5 bg-surface-50 border border-surface-300 rounded-xl text-sm text-surface-900 focus:border-brand-500">
