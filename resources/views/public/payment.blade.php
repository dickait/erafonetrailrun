                        ...
                        @if($participant->payment_status == 'pending' && isset($participant->latestPayment))
                            <div class="mt-8">
                                ...
                                @elseif(config('services.payment') === 'midtrans')
                                    <div class="mb-6">
                                        <h4 class="font-display font-bold text-surface-900 mb-4 text-sm uppercase tracking-wider">{{ __('messages.part_payment_complete_title') }}</h4>
                                    ...
                                    <div class="bg-brand-50 p-4 rounded-xl border border-brand-100 mb-6">
                                        <div class="flex justify-between items-center text-sm mb-1 text-surface-600">
                                            <span>Subtotal</span>
                                            <span id="display-subtotal" data-val="{{ (int) $finalAmount }}">Rp {{ number_format($finalAmount, 0, ',', '.') }}</span>
                                        </div>
                                        ...
                                        <div class="flex justify-between items-center pt-2 border-t border-brand-200">
                                            ...
                                            <span id="display-grandtotal" class="font-bold text-brand-600 text-lg">Rp {{ number_format($finalAmount, 0, ',', '.') }}</span>
                                        </div>
                                    </div>
