...
@section('title', 'Login - Erafone Trail Run')
@section('content')
    ...
    <div class="max-w-md mx-auto w-full px-4 sm:px-6">
        ...
        <form method="POST" action="{{ route('login') }}" class="bg-dark-800 rounded-2xl border border-forest-900/30 p-6 space-y-5">
            ...
            <div class="flex items-center justify-between">
                ...
                <a href="{{ route('password.request') }}" class="text-sm text-forest-400 hover:text-forest-300 transition-colors">Forgot password?</a>
                @endif
            </div>
