    ...
    <nav id="main-nav" class="fixed top-0 left-0 right-0 z-50 bg-white border-b border-surface-300 shadow-sm">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16 md:h-20">
                <a href="{{ route('home') }}" class="flex items-center gap-3 group">
                    ...
                    <img src="{{ asset('erafone-bg-teks.webp') }}" class="h-10 md:h-12 w-auto" alt="ERA TRAIL RUN" />
                </a>
                ...
                <div class="hidden md:flex items-center gap-4">
                    ...
                    @else
                        <span class="px-5 py-2.5 bg-surface-200 text-surface-500 text-sm font-semibold rounded-xl cursor-not-allowed">
        ...
        <div id="mobile-menu" class="hidden md:hidden border-t border-surface-300 bg-white/95 backdrop-blur-xl">
            <div class="px-4 py-4 space-y-2">
                ...
                @else
                    <span class="block px-4 py-2.5 rounded-lg text-sm font-semibold text-surface-500 bg-surface-100 text-center">{{ __('messages.nav_reg_closed') }}</span>
                @endif
            </div>
        </div>
    </nav>
                ...
                <div class="md:col-span-2">
                    <div class="flex items-center gap-3 mb-4">
                        ...
                        <img src="{{ asset('eratrailrun-putih.webp') }}" class="h-10 md:h-12 w-auto"
                            alt="ERA TRAIL RUN" />
                        <img src="{{ asset('erafone-bg-teks.webp') }}" class="h-10 md:h-12 w-auto"
                            alt="ERA TRAIL RUN" />
                    </div>
